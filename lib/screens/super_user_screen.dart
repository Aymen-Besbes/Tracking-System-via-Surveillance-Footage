...
class _PickImageState extends State<PickImage>  with SingleTickerProviderStateMixin {
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height: 10,),
            Text('Upload the person you look for', style: TextStyle(fontSize: 25, color: Colors.grey.shade800, fontWeight: FontWeight.bold),),
            //SizedBox(height: 10,),
